...
<head style="background-image:url(__PUBLIC__/bootstrap/img/bg.jpeg); background-size:cover; ;background-position:center; min-height:auto">
    ...
    <title><{$site_name}> - <?php echo _('恢复登录');?></title>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php echo _('恢复登录');?><{$site_name}></h3>
                    </div>
                    <div class="panel-body">
                        <form role="form">
                            <fieldset>
                                <div class="text-center">
                                    <img src="<{:get_gravatar_url($email)}>" class="img-circle" />
                                </div>
                                <hr />
                                ...
                                <a href="javascript:;" class="btn btn-lg btn-success btn-block" id="login"><?php echo _('恢复登录');?></a>
                            </fieldset>
                        </form>
                        <div class="pull-left">
                            <a class="btn btn-link" href="<{:U("Home/Auth/login")}>">其他账户登录</a>
                        </div>
...
$('#login').click(function(){
    ...
    function login(){
        ...
        $.post("<{:U('Home/AuthAction/login')}>", { email: $('#email').html(), 'password': password,'remember':true},
